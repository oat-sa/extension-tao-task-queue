...
define([
    ...
    QUnit.asyncTest('enqueued', function(assert) {
        var taskQueue = taskQueueModelFactory({
            url : {
                all : '/taoTaskQueue/views/js/test/component/button/taskable/samples/getAll.json',
                get : '/taoTaskQueue/views/js/test/component/button/taskable/samples/getOne.json',
            }
        }).on('error', function(){
        ...
        var taskableConfig = {
            taskQueue : taskQueue,
            taskCreationUrl : '/taoTaskQueue/views/js/test/component/button/taskable/samples/newTaskCreationResult.json',
    ...
    QUnit.asyncTest('finished', function(assert) {
        var taskQueue = taskQueueModelFactory({
            url : {
                all : '/taoTaskQueue/views/js/test/component/button/taskable/samples/getAll.json',
                get : '/taoTaskQueue/views/js/test/component/button/taskable/samples/getOne.json',
                archive : '/taoTaskQueue/views/js/test/component/button/taskable/samples/archive-success.json'
            }
        }).on('pollSingle', function(){
            //after the first poll, simulate a prompt completion of the task to trigger the finished even on time
            this.setEndpoints({
                get : '/taoTaskQueue/views/js/test/component/button/taskable/samples/getOne-completed.json'
            });
        }).on('error', function(){
            assert.ok(false, 'should not have any error');
        });
