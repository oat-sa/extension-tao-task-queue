...
return buffer+='<div class="task-detail-element">\r\n    <div class="detail-description">\r\n        <span class="label"></span>\r\n        <span class="time"></span>\r\n    </div>\r\n    <div class="action-group action-top">\r\n        <span data-role="close" class="icon-compress" title="'+escapeExpression((helper=helpers.__||depth0&&depth0.__,options={hash:{},data:data},helper?helper.call(depth0,"close report",options):helperMissing.call(depth0,"__","close report",options)))+'"/>\r\n    </div>\r\n    <div class="detail-body">\r\n    </div>\r\n    <div class="no-detail">\r\n        <span class="message">'+escapeExpression((helper=helpers.__||depth0&&depth0.__,
options={hash:{},data:data},helper?helper.call(depth0,"No report available",options):helperMissing.call(depth0,"__","No report available",options)))+"</span>\r\n    </div>\r\n</div>"})}),define("css!taoTaskQueue/component/listing/css/report",[],function(){}),define("taoTaskQueue/component/listing/report",["jquery","lodash","i18n","moment","ui/component","ui/hider","ui/report","tpl!taoTaskQueue/component/listing/tpl/report","css!taoTaskQueue/component/listing/css/report"],function($,_,__,moment,component,hider,reportFactory,elementTpl){"use strict";var _defaults={},reportElementApi={update:function(data){var $component=this.getElement();$component.find(".label").html(data.taskLabel),
data.report&&_.isArray(data.report.children)&&data.report.children.length?(this.setState("noreport",!1),reportFactory({replace:!0},data.report.children[0]).render($component.find(".detail-body"))):this.setState("noreport",!0)}};return function(config,data){var initConfig=_.defaults(config||{},_defaults);return component(reportElementApi).setTemplate(elementTpl).on("render",function(){var self=this,$component=this.getElement();this.update(data),$component.find('[data-role="close"]').click(function(){self.trigger("close")})}).init(initConfig)}}),define("tpl!taoTaskQueue/component/listing/tpl/list",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){
this.compilerInfo=[4,">= 1.0.0"],helpers=this.merge(helpers,Handlebars.helpers),data=data||{};var stack1,helper,options,buffer="",functionType="function",escapeExpression=this.escapeExpression,helperMissing=helpers.helperMissing;return buffer+='<div class="task-listing">\r\n    <div class="box">\r\n        <div class="arrow"></div>\r\n        <div class="description">',(helper=helpers.title)?stack1=helper.call(depth0,{hash:{},data:data}):(helper=depth0&&depth0.title,stack1=typeof helper===functionType?helper.call(depth0,{hash:{},data:data}):helper),buffer+=escapeExpression(stack1)+'</div>\r\n        <div class="empty-placeholder">',(helper=helpers.emptyText)?stack1=helper.call(depth0,{
hash:{},data:data}):(helper=depth0&&depth0.emptyText,stack1=typeof helper===functionType?helper.call(depth0,{hash:{},data:data}):helper),buffer+=escapeExpression(stack1)+'</div>\r\n        <ul class="task-list plain"></ul>\r\n        <div class="clear-box">\r\n            <a class="clear-all" href="#" title="'+escapeExpression((helper=helpers.__||depth0&&depth0.__,options={hash:{},data:data},helper?helper.call(depth0,"Clear all finished tasks",options):helperMissing.call(depth0,"__","Clear all finished tasks",options)))+'">'+escapeExpression((helper=helpers.__||depth0&&depth0.__,options={hash:{},data:data},helper?helper.call(depth0,"Clear all finished",options):helperMissing.call(depth0,"__","Clear all finished",options)))+'</a>\r\n        </div>\r\n        <div class="view-detail"></div>\r\n    </div>\r\n</div>';
})}),define("tpl!taoTaskQueue/component/listing/tpl/elementWrapper",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){this.compilerInfo=[4,">= 1.0.0"],helpers=this.merge(helpers,Handlebars.helpers),data=data||{};var stack1,helper,buffer="",functionType="function",escapeExpression=this.escapeExpression;return buffer+='<li data-id="',(helper=helpers.id)?stack1=helper.call(depth0,{hash:{},data:data}):(helper=depth0&&depth0.id,stack1=typeof helper===functionType?helper.call(depth0,{hash:{},data:data}):helper),buffer+=escapeExpression(stack1)+'"></li>'})}),define("css!taoTaskQueue/component/listing/css/list",[],function(){}),
define("taoTaskQueue/component/listing/list",["jquery","lodash","i18n","ui/component","taoTaskQueue/component/listing/element","tpl!taoTaskQueue/component/listing/tpl/list","tpl!taoTaskQueue/component/listing/tpl/elementWrapper","css!taoTaskQueue/component/listing/css/list"],function($,_,__,component,listElementFactory,listTpl,elementWrapperTpl){"use strict";var _defaults={title:"Task List",emptyText:__("The list is currently empty.")},listApi={removeElement:function(listElement){return listElement.destroy(),this.getElement().find('ul li[data-id="'+listElement.getId()+'"]').remove(),this},insertElement:function(listElement){var id=listElement.getId(),$li=$(elementWrapperTpl({
id:id}));return this.getElement().find("ul").prepend($li),listElement.render($li),this},setDetail:function(detailElement,show){return detailElement.render(this.getElement().find(".view-detail")),show&&this.setState("detail-view",!0),this},hideDetail:function(){return this.setState("detail-view",!1),this},scrollToTop:function(){return this.getElement().find(".task-list").get(0).scrollTo(0,0),this},animateInsertion:function(listElement){var $listElement=listElement.getElement(),$container=$listElement.parent();return $container.addClass("inserting"),$listElement.addClass("new-element"),_.delay(function(){$container.removeClass("inserting"),_.delay(function(){$listElement.removeClass("new-element");
},400)},100),this}};return function(config){var initConfig=_.defaults(config||{},_defaults);return component(listApi).setTemplate(listTpl).on("render",function(){var self=this;this.getElement().find(".clear-all").on("click",function(e){e.preventDefault(),self.trigger("clearall")})}).init(initConfig)}}),define("tpl!taoTaskQueue/component/manager/tpl/manager",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){this.compilerInfo=[4,">= 1.0.0"],helpers=this.merge(helpers,Handlebars.helpers),data=data||{};var helper,options,buffer="",helperMissing=helpers.helperMissing,escapeExpression=this.escapeExpression;return buffer+='<div class="task-manager-container" title="'+escapeExpression((helper=helpers.__||depth0&&depth0.__,
...
"use strict";var getBadgeDataFromStatus=function(tasksStatuses){var total=0,data={loading:!1};if(tasksStatuses)return tasksStatuses.numberOfTasksInProgress&&(total+=parseInt(tasksStatuses.numberOfTasksInProgress,10),data.type="info",data.loading=tasksStatuses.numberOfTasksInProgress>0),tasksStatuses.numberOfTasksCompleted&&(total+=parseInt(tasksStatuses.numberOfTasksCompleted,10),data.type="success"),tasksStatuses.numberOfTasksFailed&&(total+=parseInt(tasksStatuses.numberOfTasksFailed,10),"success"===data.type?data.type="warning":data.type="error"),data.value=total,data},getBadgeDataFromElements=function(elements){var statusMap={in_progress:"numberOfTasksInProgress",
