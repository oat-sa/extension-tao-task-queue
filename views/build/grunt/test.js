module.exports = function(grunt) {
    ...
    var testRunners = root + '/taoTaskQueue/views/js/test/**/test.html';
    var testFiles = root + '/taoTaskQueue/views/js/test/**/test.js';
    ...
    watch.taotaskqueuetest = {
        files : [testRunners, testFiles],
        tasks : ['qunit:taotaskqueuetest'],
        options : {
            debounceDelay : 10000
        }
    };
    ...
    // bundle task
    grunt.registerTask('taotaskqueuetest', ['qunit:taotaskqueuetest']);
};
